...
class _SongCardState extends State<SongCard> {
  ...
  Future<void> _openOnSpotify() async {
    try {
      final opened = await _spotifySearchService.openSongOnSpotify(widget.song);
      if (!mounted) return;
      _showSnackBar(opened ? '正在用 Spotify 搜尋這首歌' : '無法開啟 Spotify 搜尋');
    } catch (e) {
      _showSnackBar('開啟 Spotify 失敗：$e');
    }
  }
