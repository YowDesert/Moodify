...
import '../services/gemini_music_recommendation_service.dart';
...
class _RecommendPageState extends State<RecommendPage> {
  ...
  late Future<AiMusicRecommendationResult> _recommendationFuture;

  @override
  void initState() {
    super.initState();
    _recommendationFuture =
        _musicRecommendationService.recommendSongsByMood(widget.mood);
    _saveMoodRecord();
  }
  ...
  Widget _buildMusicSection() {
    return FutureBuilder<AiMusicRecommendationResult>(
