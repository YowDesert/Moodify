...
class _AiChatPageState extends State<AiChatPage> {
  ...
  final List<_PromptSuggestion> composerPrompts = const [
    _PromptSuggestion(
      ...
      title: '陪我整理心情',
      text: '我現在心情有點亂，可以陪我慢慢整理一下嗎？',
    ),
    _PromptSuggestion(
      icon: Icons.music_note_rounded,
      title: '推薦療癒音樂',
      text: '請依照我現在的心情，推薦我一些療癒一點的音樂。',
    ),
    _PromptSuggestion(
      icon: Icons.spa_rounded,
      title: '我有點焦慮',
      text: '我現在有點焦慮，想先讓自己慢慢安定下來。',
    ),
    _PromptSuggestion(
      icon: Icons.nightlight_round,
      title: '睡前放鬆',
      text: '我準備睡覺了，想聽一些柔和、放鬆的音樂。',
    ),
    _PromptSuggestion(
      icon: Icons.school_rounded,
      title: '想專心讀書',
      text: '我想專心讀書，請幫我找適合專注的音樂和方法。',
    ),
    _PromptSuggestion(
      icon: Icons.wb_sunny_outlined,
      title: '讓心情變好',
      text: '我想讓心情變好一點，請陪我聊聊也推薦一些歌。',
    ),
  ];
  ...
  void _usePromptSuggestion(String text) {
  ...
  Widget _buildComposerQuickPrompts() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
